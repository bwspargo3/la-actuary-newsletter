...
def save_outputs(markdown_content, html_content):
    ...
    with open('/home/ubuntu/newsletter_project/output/weekly_digest.md', 'w') as f:
        f.write(markdown_content)
    
    with open('/home/ubuntu/newsletter_project/output/weekly_digest.html', 'w') as f:
        f.write(html_content)
        
    print("Weekly digest generated and saved to /home/ubuntu/newsletter_project/output/")

if __name__ == "__main__":
    print("Generating 2-3 page weekly digest...")
